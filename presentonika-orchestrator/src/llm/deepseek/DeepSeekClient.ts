...
export class DeepSeekClient implements LLMClient {
  ...
  private readonly createCompletion?: (params: {
    model: string;
  ...
  constructor(options?: {
    ...
    this.timeoutMs = Number.parseInt(process.env.LLM_TIMEOUT_MS || "60000", 10);
  ...
  private async callCompletion(messages: Array<{ role: "system" | "user"; content: string }>): Promise<ChatCompletionLike> {
